...
public class WifiUtil {
    ...
    public static boolean addNetWork(WifiConfiguration cfg ,Context mContext){
        ...
        boolean flag = false;
        if (cfg.networkId > 0) {
            LogUtil.log(LogUtil.LogLevel.DEBUG,WifiUtil.class.getSimpleName(), "cfg networkId = " + cfg.networkId);
            flag = wm.enableNetwork(cfg.networkId,true);
            wm.updateNetwork(cfg);
        } else {
            int netId = wm.addNetwork(cfg);
            LogUtil.log(LogUtil.LogLevel.DEBUG,WifiUtil.class.getSimpleName(), "after adding netId = " + netId);
            if (netId > 0) {
    ...
    public static WifiConfiguration createWifiConfig(String SSID, String Password,
        ...
        LogUtil.log(LogUtil.LogLevel.DEBUG,WifiUtil.class.getSimpleName(), config.SSID );
        ...
        new Thread(
                new Runnable(){
                    ...
                    public void run() {
                        ...
                        LogUtil.log(LogUtil.LogLevel.DEBUG,WifiUtil.class.getSimpleName(), "openWifi finish... " + wm.getWifiState());
                        if (mCallBack != null) {
    ...
    public static boolean setHighestPriority(WifiManager mWifi,String ssid) {
        ...
        if (netList != null) {
            ...
            if (currentWifi != null){
                ...
                mWifi.updateNetwork(currentWifi);
