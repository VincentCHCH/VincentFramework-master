...
public class CryptoUtil {
    ...
    public static String encryptAES(String originalText){
        try {
            ...
            LogUtil.error(TAG,"encryptAES",e);
//            throw new CryptoUtilException("encryptAES");
        }
        return "";
    }
    ...
    public static String decryptAES(String encrypted) {
        try {
            ...
            LogUtil.error(TAG,"decryptAES",e);
        }
        return "";
    }
    ...
    private static byte[] getRawKey(byte[] seed){
        try {
            ...
            LogUtil.error(TAG,"getRawKey",e);
//            throw new CryptoUtilException("getRawKey");
        }
        return null;
    }

    public static byte[] encryptAES(byte[] key, byte[] clear){
        try {
