...
public class LogUtil {
    ...
    private static volatile String mLogFileName = "";
    ...
    public static void error(String tag,Throwable er){
        if (isLogEnabled){
            Log.e(tag,"",er);
        }
    }

    public static void error(String tag,String message,Throwable er){
        if (isLogEnabled){
            Log.e(tag,message,er);
        }
    }

    public static void info(String tag,String message,Throwable er){
        if (isLogEnabled){
            Log.i(tag,message,er);
        }
    }
    ...
    private static void saveLogToFile(LogLevel level, String tag, String message) {
        ...
        try {
            ...
            LogUtil.log(LogUtil.LogLevel.ERROR, "LogUtil", e.toString());
        }
    }
}
