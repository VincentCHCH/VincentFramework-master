package com.vincent.network.login.mvp.model.impl;

import android.app.Dialog;

import com.vincent.network.login.domain.UserInfo;
import com.vincent.network.login.mvp.model.ILoginModel;
import com.vincent.network.login.request.ApiService;
import com.vincent.network.login.request.DialogSubscriber;
import com.vincent.network.login.request.OkHttpUtils;
import com.vincent.network.login.request.ResponseResult;
